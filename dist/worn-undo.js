...
var wr = {
	...
	hash: "svelte-1nnfbw9",
	code: ".wrn-undo-receipt.svelte-1nnfbw9 {--wrn-undo-boundary: var(\n			--wrn-undo-border,\n			var(\n				--cockpit-border-strong,\n				color-mix(\n					in srgb,\n					var(--cockpit-border, #c8c2b9) 60%,\n					var(--cockpit-text, #21322b)\n				)\n			)\n		);display:grid;grid-template-columns:auto minmax(0, 1fr) auto;align-items:center;gap:10px;box-sizing:border-box;width:100%;max-width:100%;min-width:0;padding:10px 14px;overflow:hidden;background:var(--wrn-undo-bg, var(--cockpit-surface, #fdfbf7));border:1px solid var(--wrn-undo-boundary);border-radius:var(--wrn-undo-radius, 6px);font-family:var(--wrn-undo-font, inherit);font-size:13px;letter-spacing:0;color:var(--wrn-undo-text, var(--cockpit-text, #21322b));box-shadow:0 2px 8px rgb(0 0 0 / 6%);}.wrn-undo-icon.svelte-1nnfbw9 {flex-shrink:0;font-size:16px;opacity:0.7;}.wrn-undo-body.svelte-1nnfbw9 {display:grid;min-width:0;gap:2px;}.wrn-undo-body.svelte-1nnfbw9 strong:where(.svelte-1nnfbw9),\n	.wrn-undo-body.svelte-1nnfbw9 small:where(.svelte-1nnfbw9) {min-width:0;overflow-wrap:anywhere;}.wrn-undo-body.svelte-1nnfbw9 strong:where(.svelte-1nnfbw9) {font-size:13px;font-weight:600;}.wrn-undo-body.svelte-1nnfbw9 small:where(.svelte-1nnfbw9) {font-size:11px;color:var(--wrn-undo-muted, var(--cockpit-muted, #596a61));}.wrn-undo-actions.svelte-1nnfbw9 {display:flex;max-width:100%;flex-wrap:wrap;justify-content:flex-end;gap:4px;}.wrn-undo-btn.svelte-1nnfbw9 {min-height:32px;padding:4px 10px;border:1px solid var(--wrn-undo-boundary);border-radius:4px;background:transparent;color:var(--wrn-undo-text, var(--cockpit-text, #21322b));font:inherit;font-size:12px;letter-spacing:0;cursor:pointer;touch-action:manipulation;}.wrn-undo-btn.svelte-1nnfbw9:hover {background:var(--wrn-undo-hover, var(--cockpit-subtle, #eaf4f0));}.wrn-undo-btn.svelte-1nnfbw9:focus-visible {outline:2px solid var(--wrn-undo-focus, var(--cockpit-accent, #0f766e));outline-offset:2px;}\n\n	@media (max-width: 480px) {.wrn-undo-receipt.svelte-1nnfbw9 {grid-template-columns:auto minmax(0, 1fr);row-gap:6px;}.wrn-undo-actions.svelte-1nnfbw9 {grid-column:2;justify-content:flex-start;}\n	}\n\n	@media (pointer: coarse) {.wrn-undo-btn.svelte-1nnfbw9 {min-width:44px;min-height:44px;}\n	}\n\n	@media (forced-colors: active) {.wrn-undo-receipt.svelte-1nnfbw9,\n		.wrn-undo-btn.svelte-1nnfbw9 {border-color:CanvasText;}.wrn-undo-btn.svelte-1nnfbw9:focus-visible {outline-color:Highlight;}\n	}"
};
function jr(e, t) {
	Ve(t, !0), lr(e, Ar);
